...
class NewUserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnRegresar: ImageButton = findViewById(R.id.regresar_new_account)
        var dbRef_nuevousurio = FirebaseDatabase.getInstance().getReference("Usuarios")


        btnRegresar.setOnClickListener {
            val intent_regresar_na = Intent(this, MainActivity::class.java)
        ...
        btnCreate_account.setOnClickListener{
            ...
            val usuario = Usuario(editTextNombre.text.toString(), editTextUsername.text.toString(), userId, editTextTelefone.text.toString(), editTextEmail.text.toString(), editTextGender.text.toString(), editTextBithday.text.toString())
