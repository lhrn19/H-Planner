...
class Saturday_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        next.setOnClickListener{
            val intent_menu = Intent(this, Sunday_Activity::class.java)
            startActivity(intent_menu)}
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(snapshot.exists()){
                    for (eventSnap in snapshot.children) {
                        ...
                        if(eventData?.sabado_ingresado==true){
                    ...
                    mAdapter.SetOnItemClickListener(object: EventAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            val intent = Intent(this@Saturday_Activity,Event_detail_activity::class.java)
