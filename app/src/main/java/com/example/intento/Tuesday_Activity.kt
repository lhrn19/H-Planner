...
class Tuesday_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.tues_activity)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(snapshot.exists()){
                    for (eventSnap in snapshot.children) {
                        ...
                        if(eventData?.martes_ingresado==true){
                    ...
                    mAdapter.SetOnItemClickListener(object: EventAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            val intent = Intent(this@Tuesday_Activity,Event_detail_activity::class.java)
