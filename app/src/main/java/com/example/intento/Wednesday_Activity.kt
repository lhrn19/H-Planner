...
class Wednesday_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prev.setOnClickListener{
            val intent_menu = Intent(this, Tuesday_Activity::class.java)
            startActivity(intent_menu)}

        val next: ImageView = findViewById(R.id.arrow_next)
        next.setOnClickListener{
            val intent_menu = Intent(this, Thursday_Activity::class.java)
            startActivity(intent_menu)}
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(snapshot.exists()){
                    for (eventSnap in snapshot.children) {
                        ...
                        if(eventData?.miercoles_ingresado==true){
                    ...
                    mAdapter.SetOnItemClickListener(object: EventAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            val intent = Intent(this@Wednesday_Activity,Event_detail_activity::class.java)
